...
use JF\GeneratorBundle\Generator\ControllerGenerator;
...
EOT
    ...
    public function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            $controller = $dialog->askAndValidate($output, $dialog->getQuestion('Controller name', $input->getOption('controller')), array('JF\GeneratorBundle\Command\Validators', 'validateControllerName'), false, $input->getOption('controller'));
        ...
        $routeFormat = $dialog->askAndValidate($output, $dialog->getQuestion('Routing format (php, xml, yml, annotation)', $defaultFormat), array('JF\GeneratorBundle\Command\Validators', 'validateFormat'), false, $defaultFormat);
