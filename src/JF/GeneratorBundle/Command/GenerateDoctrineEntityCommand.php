...
use JF\GeneratorBundle\Generator\DoctrineEntityGenerator;
...
class GenerateDoctrineEntityCommand extends GenerateDoctrineCommand
{
    ...
    {
        $this
            ->setName('jf:generate:entity')
            ->setAliases(array('jf:doctrine:entity'))
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            $entity = $dialog->askAndValidate($output, $dialog->getQuestion('The Entity shortcut name', $input->getOption('entity')), array('JF\GeneratorBundle\Command\Validators', 'validateEntityName'), false, $input->getOption('entity'), $bundleNames);
        ...
        $format = $dialog->askAndValidate($output, $dialog->getQuestion('Configuration format (yml, xml, php, or annotation)', $input->getOption('format')), array('JF\GeneratorBundle\Command\Validators', 'validateFormat'), false, $input->getOption('format'), $formats);
