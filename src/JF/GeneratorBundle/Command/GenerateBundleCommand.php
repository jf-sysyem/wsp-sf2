...
use JF\GeneratorBundle\Generator\BundleGenerator;
use JF\GeneratorBundle\Manipulator\KernelManipulator;
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null === $namespace) {
            ...
            $namespace = $dialog->askAndValidate($output, $dialog->getQuestion('Bundle namespace', $input->getOption('namespace')), array('JF\GeneratorBundle\Command\Validators', 'validateBundleNamespace'), false, $input->getOption('namespace'));
        ...
        if (null === $bundle) {
            ...
            $bundle = $dialog->askAndValidate($output, $dialog->getQuestion('Bundle name', $bundle), array('JF\GeneratorBundle\Command\Validators', 'validateBundleName'), false, $bundle);
        ...
        if (null === $format) {
            ...
            $format = $dialog->askAndValidate($output, $dialog->getQuestion('Configuration format (yml, xml, php, or annotation)', $input->getOption('format')), array('JF\GeneratorBundle\Command\Validators', 'validateFormat'), false, $input->getOption('format'));
