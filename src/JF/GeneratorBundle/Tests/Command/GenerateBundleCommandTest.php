...
use JF\GeneratorBundle\Command\GenerateBundleCommand;
...
class GenerateBundleCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('JF\GeneratorBundle\Command\GenerateBundleCommand')
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('JF\GeneratorBundle\Generator\BundleGenerator')
