...
use JF\GeneratorBundle\Command\GenerateControllerCommand;
...
class GenerateControllerCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('JF\GeneratorBundle\Command\GenerateControllerCommand')
    ...
    protected function setGenerator()
    {
        ...
        $this->generator = $this
            ->getMockBuilder('JF\GeneratorBundle\Generator\ControllerGenerator')
