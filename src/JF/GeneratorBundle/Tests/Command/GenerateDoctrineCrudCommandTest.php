...
namespace JF\GeneratorBundle\Tests\Command;

use Symfony\Component\Console\Tester\CommandTester;
use JF\GeneratorBundle\Command\GenerateDoctrineCrudCommand;
...
class GenerateDoctrineCrudCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('JF\GeneratorBundle\Command\GenerateDoctrineCrudCommand')
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('JF\GeneratorBundle\Generator\DoctrineCrudGenerator')
            ->disableOriginalConstructor()
    ...
    {
        return $this
            ->getMockBuilder('JF\GeneratorBundle\Generator\DoctrineFormGenerator')
            ->disableOriginalConstructor()
            ->setMethods(array('generate'))
            ->getMock()
        ;
