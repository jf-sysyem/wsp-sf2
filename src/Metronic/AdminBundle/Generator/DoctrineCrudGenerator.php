...
namespace Metronic\AdminBundle\Generator;
...
class DoctrineCrudGenerator extends Generator
{
     ...
     */
    public function generate(BundleInterface $bundle, $entity, ClassMetadataInfo $metadata, $format, $routePrefix, $needWriteActions, $needShowActions, $needDeleteActions, $forceOverwrite)
    {
        $this->routePrefix = $routePrefix;
        $this->routeNamePrefix = str_replace('/', '_', $routePrefix);
        $this->actions = array('index');
        if($needWriteActions) {
            $this->actions = array_merge($this->actions, array('new', 'edit'));
        }
        if($needShowActions) {
            $this->actions = array_merge($this->actions, array('show'));
        }
        if($needDeleteActions) {
            $this->actions = array_merge($this->actions, array('delete'));
        }
    ...
    protected function generateControllerClass($forceOverwrite)
    {
        ...
        $has_slug = method_exists($this->bundle->getNamespace().'\Entity\\'.$this->entity, 'getSlug');
