...
use Metronic\AdminBundle\Generator\ControllerGenerator;
...
<info>BUNDLE_PATH/Resources/JFGeneratorBundle/skeleton/controller
APP_PATH/Resources/JFGeneratorBundle/skeleton/controller</info>

EOT
            )
            ->setName('jf:generate:controller')
        ;
    }
    ...
    public function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            $controller = $dialog->askAndValidate($output, $dialog->getQuestion('Controller name', $input->getOption('controller')), array('Metronic\AdminBundle\Command\Validators', 'validateControllerName'), false, $input->getOption('controller'));
        ...
        $routeFormat = $dialog->askAndValidate($output, $dialog->getQuestion('Routing format (php, xml, yml, annotation)', $defaultFormat), array('Metronic\AdminBundle\Command\Validators', 'validateFormat'), false, $defaultFormat);
