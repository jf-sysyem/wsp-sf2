...
use Metronic\AdminBundle\Generator\DoctrineCrudGenerator;
use Metronic\AdminBundle\Generator\DoctrineFormGenerator;
use Metronic\AdminBundle\Manipulator\RoutingManipulator;
...
EOT
            ...
            ->setName('metronic:admin:generate:crud')
            ->setAliases(array('metronic:admin:doctrine:crud'))
        ;
    }
    ...
    {
        $dialog = $this->getDialogHelper();
        $dialog->writeSection($output, 'Welcome to the Metronic Doctrine2 CRUD generator');
        ...
        $entity = $dialog->askAndValidate($output, $dialog->getQuestion('The Entity shortcut name', $input->getOption('entity')), array('Metronic\AdminBundle\Command\Validators', 'validateEntityName'), false, $input->getOption('entity'));
        ...
        $format = $dialog->askAndValidate($output, $dialog->getQuestion('Configuration format (yml, xml, php, or annotation)', $format), array('Metronic\AdminBundle\Command\Validators', 'validateFormat'), false, $format);
